  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
      <div class="max-w-xl lg:max-w-lg">
        ...
        <p class="mt-4 text-lg leading-8 text-gray-300">Subscribe to our newsletter for weekly updates on the latest product information, technical solutions, and case summaries.</p>
      ...
      <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
        <div class="flex flex-col items-start">
          ...
          <dd class="mt-2 leading-7 text-gray-400">Our newsletter is updated weekly to ensure you never miss out on important information.</dd>
        </div>
        <div class="flex flex-col items-start">
          <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
            <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
          ...
          <dd class="mt-2 leading-7 text-gray-400">We promise to send only valuable content, with no spam ever.</dd>
        </div>
      </dl>
    </div>
  </div>

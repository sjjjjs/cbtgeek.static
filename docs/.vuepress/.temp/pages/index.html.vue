...
<li>How To Choose Suitable Amps Cables For Station Manufacturer?</li>
<li>In which countries are common Type 1 stations installed?</li>
<li>How to choose best type 1 plug cables supplier？</li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre v-pre class="language-javascript"><code>module.exports = {
  purge: [],
  theme: {
    extend: {},
  },
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="table" tabindex="-1"><a class="header-anchor" href="#table"><span>table</span></a></h2>
<table>
<thead>
    <tr>
    <th>Wrestler</th>
